...
function decodeOutput(tokenizer, outputs, skipSpecialTokens, enableThinking) {
  ...
  async generate(data) {
    ...
    try {
      ...
      if (
        ...
        const result = await structuredOutputFunction(userInput.messages, {
          ...finalModelConfig,
          enable_thinking: finalGenerationConfig.enable_thinking,
        });
        ...
        const outputText = decodeOutput(
          ...
          finalGenerationConfig.enable_thinking,
        );
