...
// ==========================================
const CONFIG = {
  MODEL_ID: "whisper-large-v3-turbo-fast",
    ...
    switch (type) {
      ...
      case "generate":
        if (!modelState.isInitialized) {
          throw new Error(
            "Model not initialized. You must call init first to set precision and device. If issue persists, please refresh the page, reopen the browser or redownload the model.",
          );
        }
