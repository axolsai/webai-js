...
const CONFIG = {
  ...
  MODEL_REPOSITORY: "onnx-community/whisper-base_timestamped",
  MODEL_REVISION: "608c49e61301901684bc36cac8f74b95ff6b5a8e",
  WORKER_VERSION: "v4",
  ...
  SUPPORTED_PRECISIONS_DEVICES_MAP: {
    bnb4: {
      size: 144157666,
      weightsSize: 139758061,
      supportedDevices: ["wasm", "webgpu"],
      modelKeys: ["encoder_model_bnb4.onnx", "decoder_model_merged_bnb4.onnx"],
      dtype: { encoder_model: "bnb4", decoder_model_merged: "bnb4" },
    },
    q4: {
      size: 146908978,
      weightsSize: 142509373,
      supportedDevices: ["wasm", "webgpu"],
    ...
    int8: {
      size: 81271463,
      weightsSize: 76871858,
      supportedDevices: ["webgpu"],
      modelKeys: ["encoder_model_int8.onnx", "decoder_model_merged_int8.onnx"],
      dtype: { encoder_model: "int8", decoder_model_merged: "int8" },
    },
    uint8: {
      size: 81271508,
      weightsSize: 76871903,
      supportedDevices: ["webgpu"],
...
const BENCHMARK_RESULTS = [
  { precision: "fp32", device: "wasm", status: "pass", runtime: { loadMs: 44614.5, inferenceMs: 5852.3, totalMs: 50466.8, grade: "excellent", realTimeFactor: 0.1984, loadGrade: "slow" }, quality: { grade: "excellent", wordErrorRate: 0.0758, gibberish: false } },
  { precision: "fp32", device: "webgpu", status: "pass", runtime: { loadMs: 35564.1, inferenceMs: 2288.9, totalMs: 37853.1, grade: "excellent", realTimeFactor: 0.0776, loadGrade: "slow" }, quality: { grade: "excellent", wordErrorRate: 0.0758, gibberish: false } },
  { precision: "fp16", device: "wasm", status: "fail", runtime: { loadMs: null, inferenceMs: null, totalMs: 13336.3, grade: "failed" }, failure: "onnx-session-error" },
  { precision: "fp16", device: "webgpu", status: "fail", runtime: { loadMs: 54763.4, inferenceMs: 522, totalMs: 55285.5, grade: "excellent", realTimeFactor: 0.0177, loadGrade: "slow" }, quality: { grade: "failed", wordErrorRate: 1, gibberish: false }, failure: "quality-word-error-rate" },
  { precision: "int8", device: "wasm", status: "fail", runtime: { loadMs: null, inferenceMs: null, totalMs: 12096.6, grade: "failed" }, failure: "onnx-quantization-error" },
  { precision: "int8", device: "webgpu", status: "pass", runtime: { loadMs: 10712.9, inferenceMs: 8067.4, totalMs: 18780.3, grade: "good", realTimeFactor: 0.2735, loadGrade: "moderate" }, quality: { grade: "excellent", wordErrorRate: 0.1061, gibberish: false } },
  { precision: "uint8", device: "wasm", status: "fail", runtime: { loadMs: null, inferenceMs: null, totalMs: 11832.9, grade: "failed" }, failure: "onnx-quantization-error" },
  { precision: "uint8", device: "webgpu", status: "pass", runtime: { loadMs: 11453, inferenceMs: 7833.5, totalMs: 19286.5, grade: "good", realTimeFactor: 0.2656, loadGrade: "moderate" }, quality: { grade: "excellent", wordErrorRate: 0.1061, gibberish: false } },
  { precision: "q8", device: "wasm", status: "fail", runtime: { loadMs: null, inferenceMs: null, totalMs: 12240.9, grade: "failed" }, failure: "onnx-quantization-error" },
  { precision: "q8", device: "webgpu", status: "pass", runtime: { loadMs: 11845.4, inferenceMs: 7918.8, totalMs: 19764.2, grade: "good", realTimeFactor: 0.2685, loadGrade: "moderate" }, quality: { grade: "excellent", wordErrorRate: 0.0758, gibberish: false } },
  { precision: "q4", device: "wasm", status: "pass", runtime: { loadMs: 20611.6, inferenceMs: 9217.9, totalMs: 29829.5, grade: "good", realTimeFactor: 0.3126, loadGrade: "moderate" }, quality: { grade: "acceptable", wordErrorRate: 0.1667, gibberish: false } },
  { precision: "q4", device: "webgpu", status: "pass", runtime: { loadMs: 19276.7, inferenceMs: 2093.3, totalMs: 21370, grade: "excellent", realTimeFactor: 0.071, loadGrade: "moderate" }, quality: { grade: "acceptable", wordErrorRate: 0.1667, gibberish: false } },
  { precision: "q4f16", device: "wasm", status: "fail", runtime: { loadMs: null, inferenceMs: null, totalMs: 13620.5, grade: "failed" }, failure: "onnx-session-error" },
  { precision: "q4f16", device: "webgpu", status: "fail", runtime: { loadMs: 15454.3, inferenceMs: 496.4, totalMs: 15950.7, grade: "excellent", realTimeFactor: 0.0168, loadGrade: "moderate" }, quality: { grade: "failed", wordErrorRate: 0.9697, gibberish: false }, failure: "quality-word-error-rate" },
  { precision: "bnb4", device: "wasm", status: "pass", runtime: { loadMs: 21420.3, inferenceMs: 9428.1, totalMs: 30848.4, grade: "good", realTimeFactor: 0.3197, loadGrade: "moderate" }, quality: { grade: "excellent", wordErrorRate: 0.0758, gibberish: false } },
  { precision: "bnb4", device: "webgpu", status: "pass", runtime: { loadMs: 18167.8, inferenceMs: 10187.4, totalMs: 28355.2, grade: "good", realTimeFactor: 0.3454, loadGrade: "moderate" }, quality: { grade: "excellent", wordErrorRate: 0.0758, gibberish: false } },
];
...
const MANIFEST = {
  ...
  model: {
    ...
    lastUpdated: "2024-02-29T10:26:57.000Z",
    sourceRepository: "openai/whisper-base",
    repository: CONFIG.MODEL_REPOSITORY,
    artifactRevision: CONFIG.MODEL_REVISION,
    artifactLastUpdated: "2025-03-05T00:13:29.000Z",
    task: "automatic-speech-recognition",
    description: "A multilingual Whisper Base speech-recognition model that runs locally in the browser and provides higher-capacity transcription, translation to English, and optional word- or segment-level timestamps.",
    intendedUses: [
    ...
    limitations: [
      "Base requires substantially more download, memory, and compute than Whisper Tiny.",
  ...
  benchmark: {
    report: "benchmarks/whisper-base_timestamped.json",
    testedAt: "2026-09-07T15:22:40.690Z",
    fixture: {
